...
('nav', 'demolition_history', 'ja', '解体実績', 'text'),
('nav', 'demolition_history', 'en', 'Demolition History', 'text'),
('nav', 'demolition_history', 'pt', 'Histórico de Demolição', 'text'),

('nav', 'company', 'ja', '会社概要', 'text'),
('nav', 'company', 'en', 'Company Info', 'text'),
('nav', 'company', 'pt', 'Informações da Empresa', 'text'),

('nav', 'contact', 'ja', 'お問い合わせ', 'text'),
('nav', 'contact', 'en', 'Contact', 'text'),
('nav', 'contact', 'pt', 'Contato', 'text');

-- Insert default site settings
INSERT INTO site_settings (setting_key, setting_value, setting_type, description, is_public) VALUES
('site_title', '日系解体工業株式会社', 'string', 'Site title', true),
('site_description', '湘南・横浜の戸建解体工事は日系解体工業株式会社へ', 'string', 'Site description', true),
('contact_phone', '0467-38-8842', 'string', 'Contact phone number', true),
('contact_email', 'momose2201@yahoo.co.jp', 'string', 'Contact email', true),
('company_address', '神奈川県茅ヶ崎市下寺尾1759', 'string', 'Company address', true),
('company_postal', '253-0081', 'string', 'Postal code', true),
('company_fax', '0467-38-8843', 'string', 'Fax number', true);
